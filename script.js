const { degrees, PDFDocument, rgb, StandardFonts } = PDFLib
    ...
    var wardens = ['Trilok Mathur','Krishna M', 'Arun Kumar Jalan', 'Nitin Chaturvedi', 'Krishnendra Shekhawat', 'Rakhee', 'Kumar Sankar Bhattacharya', 'Praveen Kumar A.V.', 'Dipendu Bhunia', 'Sharad Shrivastava']
    ...
    firstPage.drawText(ID.value.toUpperCase(), {
        x: 302,  
        y: 710, 
        size: 12.2,
        font: helveticaFont,
